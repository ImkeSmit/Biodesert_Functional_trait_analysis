...
write.csv(results_table, "Functional trait data\\results\\FD_model_results_4Mar2024.csv")


###Interpret model results####
mod_results <- read.csv("Functional trait data\\results\\FD_model_results_4Mar2024.csv", row.names = 1)
